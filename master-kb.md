...
\*\*During the week:\*\*  
\- You maintain YOUR KB in your Google Doc  
...
\*\*Every Sunday:\*\*  
\- Claude pulls all 4 KBs from your projects  
...
\- Posts back to your Google Docs
...
After the initial greeting (which already asks if this is {{ contact.first\_name }}):
...
Do not ask if this is {{ contact.first\_name }} again — it's already asked.  
...
12\. Deploy to: Google Doc → gimmebrain/analyzer web tool
...
11\. Deploy to: Google Doc \+ Close CRM Chloe setup
...
8\. Deploy to: Google Doc → academy website
